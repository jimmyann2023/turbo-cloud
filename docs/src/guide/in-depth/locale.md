...
import { updatePreferences } from '@repo/preferences';
...
- 请不要将业务翻译文本放到 `@repo/locales` 内，这样可以更好的管理业务和通用的翻译文本。
...
{
  "about": {
    "desc": "repo Admin is a modern management template."
  }
}
````
